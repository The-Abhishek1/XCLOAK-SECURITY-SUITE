...
# Run from xcloak-agent-desktop/ directory
...
GOOS=windows GOARCH=amd64 go build \
  ...
  -o dist/xcloak-agent-desktop.exe \
...
echo "Built: dist/xcloak-agent-desktop.exe"
echo ""
echo "Windows deployment:"
echo "  1. Copy xcloak-agent-desktop.exe to target Windows machine"
echo "  2. Set SERVER_URL environment variable:"
echo "     setx SERVER_URL http://YOUR_SERVER:8080"
echo "  3. Run as Administrator:"
echo "     xcloak-agent-desktop.exe"
echo ""
echo "To install as a Windows Service:"
echo "  sc create XCloakAgent binPath= \"C:\\path\\xcloak-agent-desktop.exe\" start= auto"
