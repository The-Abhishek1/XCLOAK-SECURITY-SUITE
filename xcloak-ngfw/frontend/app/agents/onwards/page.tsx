          ...
          <div className="g-card p-6 space-y-4">
            ...
            <div>
              <p className="text-xs font-medium mb-2" style={{ color: 'var(--text-2)' }}>
                1. Create <code className="mono">xcloak-agent/.env</code>
              </p>
              <CodeBlock
            ...
            <div className="rounded-xl p-3 text-xs space-y-1"
              ...
              <p style={{ color: 'var(--text-3)' }}>
                ...
                <code className="mono">~/.config/xcloak-agent/token</code>.
        ...
        {step === 3 && (
          <div className="g-card p-6 space-y-4">
            ...
            <div>
              ...
              <CodeBlock code={`./xcloak-agent`} copyKey="run" />
            </div>
...
`✓ Agent token saved to ~/.config/xcloak-agent/token
...
sudo tee /etc/systemd/system/xcloak-agent.service << EOF
[Unit]
Description=XCloak Security Agent
After=network.target

[Service]
ExecStart=/opt/xcloak-agent/xcloak-agent
Restart=always
RestartSec=10
User=${`\${USER}`}
WorkingDirectory=/opt/xcloak-agent
