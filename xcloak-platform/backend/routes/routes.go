...
func SetupRoutes(router *gin.Engine) {
	...
	router.GET("/api/tne/dashboard", middleware.RequireAuth(), api.GetTNEDashboard)
	router.GET("/api/tne/tenants", middleware.RequireAuth(), api.GetTNETenants)
	router.POST("/api/tne/tenants", middleware.RequireAuth(), api.PostTNETenant)
	router.GET("/api/tne/tenants/:ref", middleware.RequireAuth(), api.GetTNETenantDetail)
	router.PATCH("/api/tne/tenants/:ref", middleware.RequireAuth(), api.PatchTNETenant)
	router.PATCH("/api/tne/tenants/:ref/status", middleware.RequireAuth(), api.PatchTNETenantStatus)
	router.GET("/api/tne/tenants/:ref/modules", middleware.RequireAuth(), api.GetTNEModules)
	router.PATCH("/api/tne/tenants/:ref/modules", middleware.RequireAuth(), api.PatchTNEModules)
	router.GET("/api/tne/tenants/:ref/resources", middleware.RequireAuth(), api.GetTNEResources)
	router.PATCH("/api/tne/tenants/:ref/resources", middleware.RequireAuth(), api.PatchTNEResources)
	router.GET("/api/tne/tenants/:ref/health", middleware.RequireAuth(), api.GetTNEHealth)
	router.GET("/api/tne/tenants/:ref/usage", middleware.RequireAuth(), api.GetTNEUsage)
	router.GET("/api/tne/tenants/:ref/billing", middleware.RequireAuth(), api.GetTNEBilling)
	router.GET("/api/tne/health", middleware.RequireAuth(), api.GetTNEPlatformHealth)
	router.GET("/api/tne/analytics", middleware.RequireAuth(), api.GetTNEPlatformAnalytics)
	router.POST("/api/tne/ai", middleware.RequireAuth(), api.PostTNEAI)
	router.GET("/api/tne/reports", middleware.RequireAuth(), api.GetTNEReports)
	router.GET("/api/tne/audit", middleware.RequireAuth(), api.GetTNEAudit)
