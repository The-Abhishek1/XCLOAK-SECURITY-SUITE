...
func SetupRoutes(router *gin.Engine) {
	...
	router.POST("/api/ste/tasks", middleware.RequireAuth(), middleware.RequirePermission("manage_scheduler"), api.PostSTETask)
	router.POST("/api/ste/tasks/:id/run", middleware.RequireAuth(), middleware.RequirePermission("manage_scheduler"), api.PostSTERunTask)
	router.POST("/api/ste/approvals/:id/decide", middleware.RequireAuth(), middleware.RequirePermission("manage_scheduler"), api.PostSTEApprovalDecide)
	...
	router.PATCH("/api/ste/tasks/:id", middleware.RequireAuth(), middleware.RequirePermission("manage_scheduler"), api.PatchSTETask)
	router.PATCH("/api/ste/notifications/read", middleware.RequireAuth(), api.PatchSTENotificationsRead)
	router.DELETE("/api/ste/tasks/:id", middleware.RequireAuth(), middleware.RequirePermission("manage_scheduler"), api.DeleteSTETask)
	...
	router.POST("/api/qe/items/:id/action", middleware.RequireAuth(), middleware.RequirePermission("manage_quarantine"), api.PostQEAction)
	router.POST("/api/qe/items/:id/approve", middleware.RequireAuth(), middleware.RequirePermission("manage_quarantine"), api.PostQEApprove)
	...
	router.POST("/api/aq/queue/:id/decision", middleware.RequireAuth(), middleware.RequirePermission("approve_soar_actions"), api.PostAQDecision)
	...
	router.POST("/api/pb/library", middleware.RequireAuth(), middleware.RequirePermission("manage_playbooks"), api.PostPBPlaybook)
	...
	router.PATCH("/api/pb/library/:id", middleware.RequireAuth(), middleware.RequirePermission("manage_playbooks"), api.PatchPBPlaybook)
	router.DELETE("/api/pb/library/:id", middleware.RequireAuth(), middleware.RequirePermission("manage_playbooks"), api.DeletePBPlaybook)
	router.POST("/api/pb/library/:id/publish", middleware.RequireAuth(), middleware.RequirePermission("manage_playbooks"), api.PostPBPublish)
	router.GET("/api/pb/library/:id/workflow", middleware.RequireAuth(), api.GetPBWorkflow)
	router.PATCH("/api/pb/library/:id/workflow", middleware.RequireAuth(), middleware.RequirePermission("manage_playbooks"), api.PatchPBWorkflow)
	router.POST("/api/pb/library/:id/execute", middleware.RequireAuth(), middleware.RequirePermission("manage_playbooks"), api.PostPBExecute)
