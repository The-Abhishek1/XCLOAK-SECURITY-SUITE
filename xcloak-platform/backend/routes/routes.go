...
func SetupRoutes(router *gin.Engine) {
	...
	// ── Firewall Enterprise V2 ──────────────────────────────────────────────
	router.GET("/api/fwe/dashboard", middleware.RequireAuth(), api.GetFWEDashboard)
	router.GET("/api/fwe/policies", middleware.RequireAuth(), api.GetFWEPolicies)
	router.POST("/api/fwe/policies", middleware.RequireAuth(), api.PostFWEPolicy)
	router.PATCH("/api/fwe/policies/:id", middleware.RequireAuth(), api.PatchFWEPolicy)
	router.DELETE("/api/fwe/policies/:id", middleware.RequireAuth(), api.DeleteFWEPolicy)
	router.GET("/api/fwe/zones", middleware.RequireAuth(), api.GetFWEZones)
	router.POST("/api/fwe/zones", middleware.RequireAuth(), api.PostFWEZone)
	router.GET("/api/fwe/nat", middleware.RequireAuth(), api.GetFWENAT)
	router.POST("/api/fwe/nat", middleware.RequireAuth(), api.PostFWENAT)
	router.DELETE("/api/fwe/nat/:id", middleware.RequireAuth(), api.DeleteFWENAT)
	router.GET("/api/fwe/threats", middleware.RequireAuth(), api.GetFWEThreats)
	router.GET("/api/fwe/connections", middleware.RequireAuth(), api.GetFWEConnections)
	router.GET("/api/fwe/blocked", middleware.RequireAuth(), api.GetFWEBlocked)
	router.POST("/api/fwe/block", middleware.RequireAuth(), api.PostFWEBlock)
	router.GET("/api/fwe/approvals", middleware.RequireAuth(), api.GetFWEApprovals)
	router.POST("/api/fwe/approvals", middleware.RequireAuth(), api.PostFWEApproval)
	router.POST("/api/fwe/approvals/:id/decide", middleware.RequireAuth(), api.PostFWEApprovalDecide)
	router.GET("/api/fwe/notifications", middleware.RequireAuth(), api.GetFWENotifications)
	router.PATCH("/api/fwe/notifications/read", middleware.RequireAuth(), api.PatchFWENotificationsRead)
	router.GET("/api/fwe/analytics", middleware.RequireAuth(), api.GetFWEAnalytics)
	router.GET("/api/fwe/audit", middleware.RequireAuth(), api.GetFWEAudit)
	router.POST("/api/fwe/ai", middleware.RequireAuth(), api.PostFWEAI)
	router.POST("/api/fwe/validate", middleware.RequireAuth(), api.PostFWEValidate)
	router.POST("/api/fwe/report", middleware.RequireAuth(), api.PostFWEReport)

	// ── Scheduled Tasks Enterprise ──────────────────────────────────────────
	router.GET("/api/ste/dashboard", middleware.RequireAuth(), api.GetSTEDashboard)
	router.GET("/api/ste/tasks", middleware.RequireAuth(), api.GetSTETasks)
	router.GET("/api/ste/tasks/:id", middleware.RequireAuth(), api.GetSTETask)
	router.GET("/api/ste/executions", middleware.RequireAuth(), api.GetSTEExecutions)
	router.GET("/api/ste/upcoming", middleware.RequireAuth(), api.GetSTEUpcoming)
	router.GET("/api/ste/approvals", middleware.RequireAuth(), api.GetSTEApprovals)
	router.GET("/api/ste/notifications", middleware.RequireAuth(), api.GetSTENotifications)
	router.GET("/api/ste/analytics", middleware.RequireAuth(), api.GetSTEAnalytics)
	router.GET("/api/ste/audit", middleware.RequireAuth(), api.GetSTEAudit)
	router.POST("/api/ste/tasks", middleware.RequireAuth(), api.PostSTETask)
	router.POST("/api/ste/tasks/:id/run", middleware.RequireAuth(), api.PostSTERunTask)
	router.POST("/api/ste/approvals/:id/decide", middleware.RequireAuth(), api.PostSTEApprovalDecide)
	router.POST("/api/ste/ai", middleware.RequireAuth(), api.PostSTEAI)
	router.POST("/api/ste/report", middleware.RequireAuth(), api.PostSTEReport)
	router.PATCH("/api/ste/tasks/:id", middleware.RequireAuth(), api.PatchSTETask)
	router.PATCH("/api/ste/notifications/read", middleware.RequireAuth(), api.PatchSTENotificationsRead)
	router.DELETE("/api/ste/tasks/:id", middleware.RequireAuth(), api.DeleteSTETask)
	...
	router.GET("/api/threat-hunt/mitre-coverage", middleware.RequireAuth(), api.GetThreatHuntMITRECoverage)
	...
	router.POST("/api/pb/library", middleware.RequireAuth(), api.PostPBPlaybook)
	router.POST("/api/pb/ai", middleware.RequireAuth(), api.PostPBAI)
	router.POST("/api/pb/report", middleware.RequireAuth(), api.PostPBReport)
	router.GET("/api/pb/executions", middleware.RequireAuth(), api.GetPBExecutions)
	router.GET("/api/pb/approvals", middleware.RequireAuth(), api.GetPBApprovals)
	router.GET("/api/pb/analytics", middleware.RequireAuth(), api.GetPBAnalytics)
	router.GET("/api/pb/templates", middleware.RequireAuth(), api.GetPBTemplates)
	router.GET("/api/pb/marketplace", middleware.RequireAuth(), api.GetPBMarketplace)
	router.GET("/api/pb/schedules", middleware.RequireAuth(), api.GetPBSchedules)
	router.POST("/api/pb/schedules", middleware.RequireAuth(), api.PostPBSchedule)
	router.GET("/api/pb/integrations", middleware.RequireAuth(), api.GetPBIntegrations)
	router.GET("/api/pb/library/:id", middleware.RequireAuth(), api.GetPBPlaybook)
	router.PATCH("/api/pb/library/:id", middleware.RequireAuth(), api.PatchPBPlaybook)
	router.DELETE("/api/pb/library/:id", middleware.RequireAuth(), api.DeletePBPlaybook)
	router.POST("/api/pb/library/:id/publish", middleware.RequireAuth(), api.PostPBPublish)
	router.GET("/api/pb/library/:id/workflow", middleware.RequireAuth(), api.GetPBWorkflow)
	router.PATCH("/api/pb/library/:id/workflow", middleware.RequireAuth(), api.PatchPBWorkflow)
	router.POST("/api/pb/library/:id/execute", middleware.RequireAuth(), api.PostPBExecute)
	router.POST("/api/pb/library/:id/dry-run", middleware.RequireAuth(), api.PostPBDryRun)
	router.GET("/api/pb/library/:id/versions", middleware.RequireAuth(), api.GetPBVersions)
	router.GET("/api/pb/executions/:eid", middleware.RequireAuth(), api.GetPBExecutionByID)
	router.POST("/api/pb/approvals/:aid/decision", middleware.RequireAuth(), api.PostPBApprovalDecision)
	router.POST("/api/pb/marketplace/:mid/install", middleware.RequireAuth(), api.PostPBInstall)
	router.DELETE("/api/pb/schedules/:sid", middleware.RequireAuth(), api.DeletePBSchedule)
	...
	// ── Reports Enterprise ────────────────────────────────────────────────
	router.GET("/api/rpe/dashboard", middleware.RequireAuth(), api.GetRPEDashboard)
	router.GET("/api/rpe/reports", middleware.RequireAuth(), api.GetRPEReports)
	router.POST("/api/rpe/reports", middleware.RequireAuth(), api.PostRPEReport)
	...
	router.POST("/api/rpe/templates", middleware.RequireAuth(), api.PostRPETemplate)
	router.DELETE("/api/rpe/templates/:id", middleware.RequireAuth(), api.DeleteRPETemplate)
	router.GET("/api/rpe/schedules", middleware.RequireAuth(), api.GetRPESchedules)
	router.POST("/api/rpe/schedules", middleware.RequireAuth(), api.PostRPESchedule)
	router.PATCH("/api/rpe/schedules/:id", middleware.RequireAuth(), api.PatchRPESchedule)
	router.DELETE("/api/rpe/schedules/:id", middleware.RequireAuth(), api.DeleteRPESchedule)
	router.GET("/api/rpe/executions", middleware.RequireAuth(), api.GetRPEExecutions)
	router.GET("/api/rpe/exports", middleware.RequireAuth(), api.GetRPEExports)
	router.GET("/api/rpe/shared", middleware.RequireAuth(), api.GetRPEShared)
	router.GET("/api/rpe/notifications", middleware.RequireAuth(), api.GetRPENotifications)
	router.PATCH("/api/rpe/notifications/read", middleware.RequireAuth(), api.PatchRPENotificationsRead)
	router.GET("/api/rpe/analytics", middleware.RequireAuth(), api.GetRPEAnalytics)
	router.GET("/api/rpe/audit", middleware.RequireAuth(), api.GetRPEAudit)
	router.POST("/api/rpe/ai", middleware.RequireAuth(), api.PostRPEAI)

	// ── Framework & Compliance Enterprise ─────────────────────────────────
	router.GET("/api/fce/dashboard", middleware.RequireAuth(), api.GetFCEDashboard)
	router.GET("/api/fce/frameworks", middleware.RequireAuth(), api.GetFCEFrameworks)
	router.POST("/api/fce/frameworks", middleware.RequireAuth(), api.PostFCEFramework)
	router.PATCH("/api/fce/frameworks/:id", middleware.RequireAuth(), api.PatchFCEFramework)
	router.DELETE("/api/fce/frameworks/:id", middleware.RequireAuth(), api.DeleteFCEFramework)
	router.GET("/api/fce/controls", middleware.RequireAuth(), api.GetFCEControls)
	router.PATCH("/api/fce/controls/:id", middleware.RequireAuth(), api.PatchFCEControl)
	router.GET("/api/fce/evidence", middleware.RequireAuth(), api.GetFCEEvidence)
	router.POST("/api/fce/evidence", middleware.RequireAuth(), api.PostFCEEvidence)
	router.DELETE("/api/fce/evidence/:id", middleware.RequireAuth(), api.DeleteFCEEvidence)
	router.GET("/api/fce/gaps", middleware.RequireAuth(), api.GetFCEGapAnalysis)
	router.GET("/api/fce/assessments", middleware.RequireAuth(), api.GetFCEAssessments)
	router.POST("/api/fce/assessments", middleware.RequireAuth(), api.PostFCEAssessment)
	router.GET("/api/fce/remediations", middleware.RequireAuth(), api.GetFCERemediations)
	router.POST("/api/fce/remediations", middleware.RequireAuth(), api.PostFCERemediation)
	router.PATCH("/api/fce/remediations/:id", middleware.RequireAuth(), api.PatchFCERemediation)
	router.GET("/api/fce/notifications", middleware.RequireAuth(), api.GetFCENotifications)
	router.PATCH("/api/fce/notifications/read", middleware.RequireAuth(), api.PatchFCENotificationsRead)
	router.GET("/api/fce/analytics", middleware.RequireAuth(), api.GetFCEAnalytics)
	router.GET("/api/fce/audit", middleware.RequireAuth(), api.GetFCEAudit)
	router.POST("/api/fce/ai", middleware.RequireAuth(), api.PostFCEAI)

	// ── Executive Enterprise ───────────────────────────────────────────────
	router.GET("/api/exe/dashboard", middleware.RequireAuth(), api.GetEXEDashboard)
	router.GET("/api/exe/risk", middleware.RequireAuth(), api.GetEXERisk)
	router.GET("/api/exe/kpis", middleware.RequireAuth(), api.GetEXEKPIs)
	router.GET("/api/exe/business-impact", middleware.RequireAuth(), api.GetEXEBusinessImpact)
	router.GET("/api/exe/threat-landscape", middleware.RequireAuth(), api.GetEXEThreatLandscape)
	router.GET("/api/exe/compliance", middleware.RequireAuth(), api.GetEXECompliance)
	router.GET("/api/exe/vulnerabilities", middleware.RequireAuth(), api.GetEXEVulns)
	router.GET("/api/exe/incidents", middleware.RequireAuth(), api.GetEXEIncidents)
	router.GET("/api/exe/assets", middleware.RequireAuth(), api.GetEXEAssets)
	router.GET("/api/exe/forecasting", middleware.RequireAuth(), api.GetEXEForecasting)
	router.GET("/api/exe/analytics", middleware.RequireAuth(), api.GetEXEAnalytics)
	router.GET("/api/exe/reports", middleware.RequireAuth(), api.GetEXEReports)
	router.POST("/api/exe/reports", middleware.RequireAuth(), api.PostEXEReport)
	router.GET("/api/exe/notifications", middleware.RequireAuth(), api.GetEXENotifications)
	router.PATCH("/api/exe/notifications/read", middleware.RequireAuth(), api.PatchEXENotificationsRead)
	router.GET("/api/exe/integrations", middleware.RequireAuth(), api.GetEXEIntegrations)
	router.GET("/api/exe/audit", middleware.RequireAuth(), api.GetEXEAudit)
	router.POST("/api/exe/ai", middleware.RequireAuth(), api.PostEXEAI)

	// ── SOC Metrics Enterprise ─────────────────────────────────────────────
	router.GET("/api/sme/dashboard", middleware.RequireAuth(), api.GetSMEDashboard)
	router.GET("/api/sme/alerts", middleware.RequireAuth(), api.GetSMEAlerts)
	router.GET("/api/sme/incidents", middleware.RequireAuth(), api.GetSMEIncidents)
	router.GET("/api/sme/cases", middleware.RequireAuth(), api.GetSMECases)
	router.GET("/api/sme/analysts", middleware.RequireAuth(), api.GetSMEAnalysts)
	router.GET("/api/sme/detection", middleware.RequireAuth(), api.GetSMEDetection)
	router.GET("/api/sme/automation", middleware.RequireAuth(), api.GetSMEAutomation)
	router.GET("/api/sme/threats", middleware.RequireAuth(), api.GetSMEThreats)
	router.GET("/api/sme/endpoints", middleware.RequireAuth(), api.GetSMEEndpoints)
	router.GET("/api/sme/vulns", middleware.RequireAuth(), api.GetSMEVulns)
	router.GET("/api/sme/compliance", middleware.RequireAuth(), api.GetSMECompliance)
	router.GET("/api/sme/infrastructure", middleware.RequireAuth(), api.GetSMEInfrastructure)
	router.GET("/api/sme/reports", middleware.RequireAuth(), api.GetSMEReports)
	router.POST("/api/sme/reports", middleware.RequireAuth(), api.PostSMEReport)
	router.GET("/api/sme/notifications", middleware.RequireAuth(), api.GetSMENotifications)
	router.PATCH("/api/sme/notifications/read", middleware.RequireAuth(), api.PatchSMENotificationsRead)
	router.GET("/api/sme/audit", middleware.RequireAuth(), api.GetSMEAudit)
	router.POST("/api/sme/ai", middleware.RequireAuth(), api.PostSMEAI)

	// ── Assets CMDB Enterprise ────────────────────────────────────────────────
	router.GET("/api/ace/dashboard", middleware.RequireAuth(), api.GetACEDashboard)
	router.GET("/api/ace/assets", middleware.RequireAuth(), api.GetACEAssets)
	router.GET("/api/ace/assets/:id", middleware.RequireAuth(), api.GetACEAssetDetail)
	router.PATCH("/api/ace/assets/:id", middleware.RequireAuth(), api.PatchACEAsset)
	router.GET("/api/ace/assets/:id/timeline", middleware.RequireAuth(), api.GetACETimeline)
	router.GET("/api/ace/relationships", middleware.RequireAuth(), api.GetACERelationships)
	router.GET("/api/ace/discovery", middleware.RequireAuth(), api.GetACEDiscovery)
	router.GET("/api/ace/health", middleware.RequireAuth(), api.GetACEHealth)
	router.GET("/api/ace/risk", middleware.RequireAuth(), api.GetACERisk)
	router.GET("/api/ace/analytics", middleware.RequireAuth(), api.GetACEAnalytics)
	router.GET("/api/ace/compliance", middleware.RequireAuth(), api.GetACECompliance)
	router.GET("/api/ace/security", middleware.RequireAuth(), api.GetACESecurityEvents)
	router.POST("/api/ace/bulk", middleware.RequireAuth(), api.PostACEBulk)
	router.GET("/api/ace/reports", middleware.RequireAuth(), api.GetACEReports)
	router.POST("/api/ace/reports", middleware.RequireAuth(), api.PostACEReport)
	router.GET("/api/ace/notifications", middleware.RequireAuth(), api.GetACENotifications)
	router.PATCH("/api/ace/notifications/read", middleware.RequireAuth(), api.PatchACENotificationsRead)
	router.GET("/api/ace/audit", middleware.RequireAuth(), api.GetACEAudit)
	router.POST("/api/ace/ai", middleware.RequireAuth(), api.PostACEAI)

	// ── MDM Enterprise ────────────────────────────────────────────────────────
	router.GET("/api/mdme/dashboard", middleware.RequireAuth(), api.GetMDMEDashboard)
	router.GET("/api/mdme/devices", middleware.RequireAuth(), api.GetMDMEDevices)
	router.GET("/api/mdme/devices/:id", middleware.RequireAuth(), api.GetMDMEDeviceDetail)
	router.GET("/api/mdme/devices/:id/timeline", middleware.RequireAuth(), api.GetMDMETimeline)
	router.GET("/api/mdme/apps", middleware.RequireAuth(), api.GetMDMEApps)
	router.GET("/api/mdme/policies", middleware.RequireAuth(), api.GetMDMEPolicies)
	router.GET("/api/mdme/compliance", middleware.RequireAuth(), api.GetMDMECompliance)
	router.GET("/api/mdme/remote-actions", middleware.RequireAuth(), api.GetMDMERemoteActions)
	router.POST("/api/mdme/remote-actions", middleware.RequireAuth(), api.PostMDMERemoteAction)
	router.GET("/api/mdme/threats", middleware.RequireAuth(), api.GetMDMEThreats)
	router.PATCH("/api/mdme/threats/:id", middleware.RequireAuth(), api.PatchMDMEThreat)
	router.GET("/api/mdme/analytics", middleware.RequireAuth(), api.GetMDMEAnalytics)
	router.POST("/api/mdme/ai", middleware.RequireAuth(), api.PostMDMEAI)
	router.GET("/api/mdme/reports", middleware.RequireAuth(), api.GetMDMEReports)
	router.POST("/api/mdme/reports", middleware.RequireAuth(), api.PostMDMEReport)
	router.GET("/api/mdme/notifications", middleware.RequireAuth(), api.GetMDMENotifications)
	router.PATCH("/api/mdme/notifications/read", middleware.RequireAuth(), api.PatchMDMENotificationsRead)
	...
	router.GET("/api/aia/dashboard", middleware.RequireAuth(), api.GetAIADashboard)
	router.GET("/api/aia/sessions", middleware.RequireAuth(), api.GetAIASessions)
	router.POST("/api/aia/sessions", middleware.RequireAuth(), api.PostAIASession)
	router.GET("/api/aia/sessions/:id/messages", middleware.RequireAuth(), api.GetAIASessionMessages)
	router.PATCH("/api/aia/sessions/:id", middleware.RequireAuth(), api.PatchAIASession)
	router.POST("/api/aia/chat", middleware.RequireAuth(), api.PostAIAChat)
	router.GET("/api/aia/recommendations", middleware.RequireAuth(), api.GetAIARecommendations)
	router.PATCH("/api/aia/recommendations/:id", middleware.RequireAuth(), api.PatchAIARecommendation)
	router.GET("/api/aia/actions", middleware.RequireAuth(), api.GetAIAActions)
	router.POST("/api/aia/actions", middleware.RequireAuth(), api.PostAIAAction)
	router.PATCH("/api/aia/actions/:id/approve", middleware.RequireAuth(), api.PatchAIAActionApprove)
	router.GET("/api/aia/prompts", middleware.RequireAuth(), api.GetAIAPrompts)
	router.POST("/api/aia/prompts", middleware.RequireAuth(), api.PostAIAPrompt)
	router.GET("/api/aia/analytics", middleware.RequireAuth(), api.GetAIAAnalytics)
	router.GET("/api/aia/reports", middleware.RequireAuth(), api.GetAIAReports)
	router.POST("/api/aia/reports", middleware.RequireAuth(), api.PostAIAReport)
	router.GET("/api/aia/audit", middleware.RequireAuth(), api.GetAIAAudit)

	// ── Tenants Enterprise (/api/tne/) ─────────────────────────────────────────
	// Platform-wide demo/reference multi-tenant console — same blast radius as
	// /api/platform/*, so it's gated the same way.
	router.GET("/api/tne/dashboard", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEDashboard)
	router.GET("/api/tne/tenants", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNETenants)
	router.POST("/api/tne/tenants", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.PostTNETenant)
	router.GET("/api/tne/tenants/:ref", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNETenantDetail)
	router.PATCH("/api/tne/tenants/:ref", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.PatchTNETenant)
	router.PATCH("/api/tne/tenants/:ref/status", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.PatchTNETenantStatus)
	router.GET("/api/tne/tenants/:ref/modules", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEModules)
	router.PATCH("/api/tne/tenants/:ref/modules", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.PatchTNEModules)
	router.GET("/api/tne/tenants/:ref/resources", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEResources)
	router.PATCH("/api/tne/tenants/:ref/resources", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.PatchTNEResources)
	router.GET("/api/tne/tenants/:ref/health", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEHealth)
	router.GET("/api/tne/tenants/:ref/usage", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEUsage)
	router.GET("/api/tne/tenants/:ref/billing", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEBilling)
	router.GET("/api/tne/health", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEPlatformHealth)
	router.GET("/api/tne/analytics", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEPlatformAnalytics)
	router.POST("/api/tne/ai", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.PostTNEAI)
	router.GET("/api/tne/reports", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEReports)
	router.GET("/api/tne/audit", middleware.RequireAuth(), middleware.RequirePlatformAdmin(), api.GetTNEAudit)
