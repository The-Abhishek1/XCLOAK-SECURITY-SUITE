...
export default function EmailSecurityPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-[var(--text-1)]">Email Security</h1>
        <p className="text-sm text-[var(--text-3)] mt-1">Phishing · BEC · Malware · URL Analysis · DMARC · Campaign Detection</p>
      </div>
