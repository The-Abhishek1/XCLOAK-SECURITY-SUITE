  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
        ...
        <MetricCard label="Max Potential Loss"   value={fmtNum(impact.max_potential_loss  || 0)} color="#f97316" />
        <MetricCard label="Avg Recovery Cost"    value={fmtNum(impact.avg_recovery_cost   || 0)} color="#eab308" />
        <MetricCard label="Cyber Insurance"      value={impact.cyber_insurance_coverage || '—'}  />
      </div>
