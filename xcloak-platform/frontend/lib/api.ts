...
export const casesAPI = {
  ...
  updateCase:     (id: number, data: any) => api.patch(`/cases/${id}`, data),
  deleteCase:     (id: number)   => api.delete(`/cases/${id}`),
  getTasks:       (id: number)   => api.get(`/cases/${id}/tasks`).catch(() => ({ data: [] })),
  createTask:     (id: number, data: any) => api.post(`/cases/${id}/tasks`, data),
  updateTask:     (id: number, tid: number, data: any) => api.patch(`/cases/${id}/tasks/${tid}`, data),
  ...
  addNote:        (id: number, data: any) => api.post(`/cases/${id}/notes`, data),
  getTimeline:    (id: number)   => api.get(`/cases/${id}/timeline`).catch(() => ({ data: [] })),
  getComments:    (id: number)   => api.get(`/cases/${id}/comments`).catch(() => ({ data: [] })),
  addComment:     (id: number, data: any) => api.post(`/cases/${id}/comments`, data),
